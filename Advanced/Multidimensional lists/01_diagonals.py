...
print(f"Primary diagonal: {', '.join([str(el) for el in primary_diagonal])}. Sum: {primary_sum}")
print(f"Secondary diagonal: {', '.join([str(el) for el in secondary_diagonal])}. Sum: {secondary_sum}")
